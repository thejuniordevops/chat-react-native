...
export const CADASTRO_USUARIO_SUCESSO = 'sucesso';
...
export const ADICIONA_CONTATOS_ERRO = 'adiciona_contato_erro';
export const ADICIONA_CONTATOS_SUCESSO = 'adiciona_contatos_sucesso';
